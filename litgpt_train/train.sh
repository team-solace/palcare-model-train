...
litgpt finetune_lora --devices 2 --lora_r 32 --lora_alpha 16 --lora_dropout 0.05 --lora_query true --lora_value true --train.lr_warmup_steps 10 --train.global_batch_size 64 --train.micro_batch_size 1 --data MedInstructAlign --precision bf16-true --logger_name wandb checkpoints/lemousehunter/epflllm_meditron-7b-base
